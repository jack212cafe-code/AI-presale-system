...
export const LOCAL_USERS = [
  { username: "admin", password_hash: "$2b$12$ICJce.vNUx0raVlG5AtlxOsLu24MSqWbJmjEckGyK020ub.hPzDxa", display_name: "Administrator", role: "admin" },
...
export function getSessionUser(request) {
  ...
  session.expiresAt = Date.now() + SESSION_TTL_MS;
  return { userId: session.userId, displayName: session.displayName, role: session.role ?? "engineer" };
}
