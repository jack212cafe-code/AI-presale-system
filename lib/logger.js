...
async function writeAgentLogSafely(entry) {
  try {
    const { writeAgentLog } = await import("./supabase.js");
...
export async function withAgentLogging({ agentName, projectId, userId, orgId, modelUsed, input, kbChunksInjected }, runner) {
