...
function validateArchitectureTopology(architecture, storage_items, requested_topology) {
  ...
  if (requested_topology.toUpperCase() === 'HCI') {
    ...
    const isSanProduct = /powerstore|power-vault|me5|msa/i.test(itemsLower);
 ...
 * @param {Object} option { licenses: [], storage_items: [], notes: "", architecture: "" }
 * @param {Object} context { user_count: number, requested_topology: string }
