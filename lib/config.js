...
export const config = {
  ...
  openai: {
    ...
    models: {
      discovery: process.env.OPENAI_MODEL_DISCOVERY || DEFAULT_MODEL,
      solution: process.env.OPENAI_MODEL_SOLUTION || DEFAULT_MODEL,
      bom: process.env.OPENAI_MODEL_BOM || DEFAULT_MODEL,
      proposal: process.env.OPENAI_MODEL_PROPOSAL || DEFAULT_MODEL
    }
  },
  embeddings: {
