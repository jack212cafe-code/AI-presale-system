...
const MODEL_PREMIUM = "gpt-4o-mini";
...
export const config = {
  ...
  openai: {
    ...
    models: {
      ...
      wiki: process.env.OPENAI_MODEL_WIKI || MODEL_STANDARD,
      diagram: process.env.OPENAI_MODEL_DIAGRAM || MODEL_STANDARD
    },
    sessionTokenBudget: toPositiveInt(process.env.OPENAI_SESSION_TOKEN_BUDGET, 50000),
    userMonthlyBudget: parseFloat(process.env.OPENAI_USER_MONTHLY_BUDGET ?? "15")
  },
  sentry: {
